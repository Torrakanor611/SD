...
sshpass -f password ssh sd102@l040101-ws08.ua.pt 'cd test/Restaurant ; unzip -uq dirRegistry.zip'
echo "Executing program at the registry node."
sshpass -f password ssh sd102@l040101-ws08.ua.pt 'cd test/Restaurant/dirRegistry ; ./registry_com_d.sh sd102'
