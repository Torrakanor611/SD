...
sshpass -f password ssh sd102@l040101-ws01.ua.pt 'cd test/Restaurant/dirRMIRegistry ; cp interfaces/*.class /home/ruib/Public/classes/interfaces ; cp set_rmiregistry_d.sh /home/ruib'
echo "Executing program at the RMIregistry node."
sshpass -f password ssh sd102@l040101-ws08.ua.pt './set_rmiregistry_d.sh sd102 22110'
