...
sshpass -f password ssh sd102@l040101-ws08.ua.pt 'cd test/SleepingBarbers/dirGeneralRepos ; ./repos_com_d.sh sd102'
echo "Server shutdown."
sshpass -f password ssh sd102@l040101-ws08.ua.pt 'cd test/SleepingBarbers/dirGeneralRepos ; less logger'